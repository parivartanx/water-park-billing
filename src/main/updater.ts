...
// No need for token configuration since the repository is public

// Since the repository is now public, we don't need a token
log.info('Configuring auto-updater for public repository')
